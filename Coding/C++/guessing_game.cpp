// Guessing game for a user to find the number between 1 and 100. The game will tell your current number of tries and if your guess was too high or too low
#include<iostream>
#include<stdlib.h>
using namespace std;
